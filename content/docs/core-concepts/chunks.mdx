...
export const metadata = {
  title: "Chunks — Stunk",
  description:
    "The core primitive of Stunk. Create reactive state units that notify subscribers when values change.",
  openGraph: {
    title: "Chunks — Stunk",
    description:
      "The core primitive of Stunk — reactive state units with get, set, subscribe, derive and more.",
    url: "https://stunk.dev/docs/chunks",
  },
};
