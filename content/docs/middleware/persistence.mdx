...
export const metadata = {
  title: "Persist — Stunk",
  description: "Persist any chunk to localStorage with zero configuration.",
  openGraph: {
    title: "Persist — Stunk",
    description:
      "Persist chunk state across page reloads with the persist middleware.",
    url: "https://stunk.dev/docs/middleware/persist",
  },
};
