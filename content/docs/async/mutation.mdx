...
export const metadata = {
  title: "Mutation — Stunk",
  description:
    "Reactive mutations for POST, PUT and DELETE operations with automatic cache invalidation.",
  openGraph: {
    title: "Mutation — Stunk",
    description:
      "Trigger mutations and automatically invalidate related async chunks on success.",
    url: "https://stunk.dev/docs/async/mutation",
  },
};
