...
export const metadata = {
  title: "Async Chunk — Stunk",
  description:
    "Handle async operations with built-in loading, error, and data states. Built-in loading, error, caching, retries and params support.",
  openGraph: {
    title: "Async Chunk — Stunk",
    description:
      "Handle async operations with built-in loading, error, and data states.",
    url: "https://stunk.dev/docs/async/async-chunk",
  },
  twitter: {
