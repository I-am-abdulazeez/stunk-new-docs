...
export const metadata = {
  title: "React Integration — Stunk",
  description:
    "Official React hooks for Stunk — useChunk, useChunkValue, useAsyncChunk, useMutation and more.",
  openGraph: {
    title: "React Integration — Stunk",
    description:
      "useChunk, useChunkValue, useAsyncChunk, useMutation, useInfiniteAsyncChunk — all in stunk/react.",
    url: "https://stunk.dev/docs/integrations/react",
  },
};
